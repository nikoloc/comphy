...
void
toplevel_set_initial_state(struct mwc_toplevel *toplevel, uint32_t x, uint32_t y, uint32_t width, uint32_t height);

void
toplevel_set_pending_state(struct mwc_toplevel *toplevel, uint32_t x, uint32_t y, uint32_t width, uint32_t height);
