.PHONY: clean
build/comphy: build/_objects/comphy.action.o build/_objects/comphy.action_parser.o build/_objects/comphy.backend.o build/_objects/comphy.color.o build/_objects/comphy.comphy.o build/_objects/comphy.config.o build/_objects/comphy.ctl.o build/_objects/comphy.cursor.o build/_objects/comphy.decoration.o build/_objects/comphy.ext_workspace.o build/_objects/comphy.gamma_control.o build/_objects/comphy.keybind.o build/_objects/comphy.keyboard.o build/_objects/comphy.layer.o build/_objects/comphy.layer_shell.o build/_objects/comphy.layout.o build/_objects/comphy.lock.o build/_objects/comphy.operation.o build/_objects/comphy.output.o build/_objects/comphy.pointer.o build/_objects/comphy.popup.o build/_objects/comphy.rules.o build/_objects/comphy.scene.o build/_objects/comphy.seat.o build/_objects/comphy.state.o build/_objects/comphy.system.o build/_objects/comphy.toplevel.o build/_objects/comphy.transaction.o build/_objects/comphy.view.o build/_objects/comphy.workspace.o build/_objects/comphy.xdg_shell.o
	cc -I. -Iinclude -Igenerated -I/usr/include/wlroots-0.20 -I/usr/include/pixman-1 -I/usr/include/libdrm -lwlroots-0.20 -lwayland-server -lm -lxkbcommon -linput -g -O0 -Wall -Wextra -Wpedantic -Wnull-dereference -fsanitize=address,undefined -fno-omit-frame-pointer -DDEBUG -lm -DWLR_USE_UNSTABLE -D_GNU_SOURCE -o build/comphy build/_objects/comphy.action.o build/_objects/comphy.action_parser.o build/_objects/comphy.backend.o build/_objects/comphy.color.o build/_objects/comphy.comphy.o build/_objects/comphy.config.o build/_objects/comphy.ctl.o build/_objects/comphy.cursor.o build/_objects/comphy.decoration.o build/_objects/comphy.ext_workspace.o build/_objects/comphy.gamma_control.o build/_objects/comphy.keybind.o build/_objects/comphy.keyboard.o build/_objects/comphy.layer.o build/_objects/comphy.layer_shell.o build/_objects/comphy.layout.o build/_objects/comphy.lock.o build/_objects/comphy.operation.o build/_objects/comphy.output.o build/_objects/comphy.pointer.o build/_objects/comphy.popup.o build/_objects/comphy.rules.o build/_objects/comphy.scene.o build/_objects/comphy.seat.o build/_objects/comphy.state.o build/_objects/comphy.system.o build/_objects/comphy.toplevel.o build/_objects/comphy.transaction.o build/_objects/comphy.view.o build/_objects/comphy.workspace.o build/_objects/comphy.xdg_shell.o
clean: Makefile
...
build/_objects/comphy.ext_workspace.o: src/ext_workspace.c
	cc -c -I. -Iinclude -Igenerated -I/usr/include/wlroots-0.20 -I/usr/include/pixman-1 -I/usr/include/libdrm -lwlroots-0.20 -lwayland-server -lm -lxkbcommon -linput -g -O0 -Wall -Wextra -Wpedantic -Wnull-dereference -fsanitize=address,undefined -fno-omit-frame-pointer -DDEBUG -lm -DWLR_USE_UNSTABLE -D_GNU_SOURCE -o build/_objects/comphy.ext_workspace.o -MMD -MP -MF build/_deps/comphy.ext_workspace.d src/ext_workspace.c
-include build/_deps/comphy.ext_workspace.d
