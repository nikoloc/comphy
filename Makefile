.PHONY: clean
build/comphy/comphy: build/comphy/action.o build/comphy/action_parser.o build/comphy/backend.o build/comphy/color.o build/comphy/comphy.o build/comphy/config.o build/comphy/ctl.o build/comphy/cursor.o build/comphy/decoration.o build/comphy/gamma_control.o build/comphy/keyboard.o build/comphy/layer_shell.o build/comphy/layout.o build/comphy/lock.o build/comphy/operation.o build/comphy/output.o build/comphy/pointer.o build/comphy/popup.o build/comphy/scene.o build/comphy/seat.o build/comphy/state.o build/comphy/system.o build/comphy/toplevel.o build/comphy/transaction.o build/comphy/view.o build/comphy/workspace.o build/comphy/xdg_shell.o
	cc -I. -Iinclude -Igenerated -I/usr/include/wlroots-0.20 -I/usr/include/pixman-1 -I/usr/include/libdrm -lwlroots-0.20 -lwayland-server -lm -lxkbcommon -linput -g -O0 -Wall -Wextra -Wpedantic -Wnull-dereference -fsanitize=address,undefined -fno-omit-frame-pointer -DDEBUG -lm -DWLR_USE_UNSTABLE -D_GNU_SOURCE -o build/comphy/comphy build/comphy/action.o build/comphy/action_parser.o build/comphy/backend.o build/comphy/color.o build/comphy/comphy.o build/comphy/config.o build/comphy/ctl.o build/comphy/cursor.o build/comphy/decoration.o build/comphy/gamma_control.o build/comphy/keyboard.o build/comphy/layer_shell.o build/comphy/layout.o build/comphy/lock.o build/comphy/operation.o build/comphy/output.o build/comphy/pointer.o build/comphy/popup.o build/comphy/scene.o build/comphy/seat.o build/comphy/state.o build/comphy/system.o build/comphy/toplevel.o build/comphy/transaction.o build/comphy/view.o build/comphy/workspace.o build/comphy/xdg_shell.o
clean: Makefile
